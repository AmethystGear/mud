...
public interface Action {
    ...
    // this command, then return false.
    // if you have some kind of error/formatting message to display, use the error
    // parameter and append your error to that.
    ...
    // run the action with the stored parameters. You can assume the parameters are
